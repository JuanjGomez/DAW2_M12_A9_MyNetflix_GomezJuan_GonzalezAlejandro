<?php
    ...
    try{
        ...
        $stmtEliminarLikes->bindParam(1, $idPelicula, PDO::PARAM_INT);
        ...
        $sqlEliminarPeliculaCategoria = "DELETE FROM tbl_pelicula_categoria 
                                        WHERE id_peli = ?";
        $stmtEliminarPeliculaCategoria = $conn->prepare($sqlEliminarPeliculaCategoria);
        $stmtEliminarPeliculaCategoria->bindParam(1, $idPelicula, PDO::PARAM_INT);
        ...
        $stmtBorrarPeli->bindParam(1, $idPelicula, PDO::PARAM_INT);
        ...
        echo "Error: " . $e->getMessage(); // Mensaje de error para depuración
        header('Location:../view/gestionarPeliculas.php');
        exit();
    }